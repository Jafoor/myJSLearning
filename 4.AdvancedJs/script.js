...
designerQuestion('rahim');

interviewQuestion('driver')('Mark');
*/

/// IIFE (Immediately Invoced Funcntion Expression)
...
var john = {
    ...
    presentation : function (style, timeOfDay){
        if (style === 'formal'){
            console.log('Good ' + timeOfDay + ', Ladis and Gentlemen! I\'m ' + this.name + '. I am a ' + this.job + '. I am ' + this.age + ' years old.')
